...
var buttonClicked = function(n)
{
	...
	if(boxStatus[n] == "left"){
		$(id).animate({marginLeft : pageWidth-boxWidtth+'px', fontsize: '25px', fontcolor : 'red'},"slow", boxFuction[n]);
		boxStatus[n] = "right";
	}else{
		$(id).animate({marginLeft : '20px', fontcolor : 'black'},"slow", boxFuction[n]);
		boxStatus[n] = "left";
	}
